...
const ALL_MENUS = [
  { path: '/dashboard', title: '数据看板', icon: 'DataAnalysis', roles: ['hr'] },
  { path: '/my-dashboard', title: '我的工作台', icon: 'HomeFilled', roles: ['employee', 'manager'] },
  { path: '/departments', title: '部门管理', icon: 'OfficeBuilding', roles: ['hr'] },
  { path: '/positions', title: '职位管理', icon: 'Briefcase', roles: ['hr'] },
  { path: '/employees', title: '员工管理', icon: 'User', roles: ['hr'] },
  { path: '/attendance/punch', title: '考勤打卡', icon: 'AlarmClock', roles: ['employee', 'manager'] },
  { path: '/attendance/rule', title: '考勤规则', icon: 'SetUp', roles: ['hr'] },
  { path: '/attendance/monthly', title: '月度考勤', icon: 'Calendar', roles: ['hr'] },
  ...
  { path: '/approval/approve', title: '待我审批', icon: 'Stamp', roles: ['manager', 'hr'] },
  { path: '/approval/all', title: '审批记录', icon: 'DocumentChecked', roles: ['hr'] },
  { path: '/performance/manage', title: '绩效管理', icon: 'Trophy', roles: ['manager', 'hr'] },
  ...
  { path: '/salary/manage', title: '薪资管理', icon: 'Money', roles: ['hr'] },
